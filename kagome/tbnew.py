...
def cal_energy(ksx,ksy,ksz):
    ...
    def Hd(kx, ky, kz):
        Hd = np.array([[d + 2 * t22 * cos(c * kz), t2 * (1 + exp(2 * 1j * (-a / 2 * kx + sqrt(3) / 2 * a * ky))),
                        t2 * (1 + exp(2 * 1j * a * kx)), 2 * 1j * t3 * sin(c * kz), 2 * 1j * t3 * sin(c * kz)],
                       [t2 * (1 + exp(-2 * 1j * c * kz)), d + 2 * t22 * cos(c * kz),
                        t2 * (exp(2 * 1j * a * kx) + exp(-2 * 1j * (-a / 2 * kx + sqrt(3) / 2 * a * ky))),
                        2j * t3 * sin(c * kz) * exp(-2 * 1j * (-a / 2 * kx + sqrt(3) / 2 * a * ky)),
                        2j * t3 * sin(c * kz)],
                       [t2 * (1 + exp(-2 * 1j * a * kx)),
                        t2 * (exp(-2 * 1j * a * kx) + exp(2 * 1j * (-a / 2 * kx + sqrt(3) / 2 * a * ky))),
                        d + 2 * t22 * cos(c * kz), 2j * t3 * sin(c * kz),
                        2j * t3 * sin(c * kz) * exp(-2 * 1j * a * kx)],
                       [-2j * t3 * sin(c * kz),
                        -2j * t3 * sin(c * kz) * exp(2 * 1j * (-a / 2 * kx + sqrt(3) / 2 * a * ky)),
                        -2j * t3 * sin(c * kz), p + 2 * t11 * cos(c * kz),
                        t1 * (1 + exp(2 * 1j * (-a / 2 * kx + sqrt(3) / 2 * a * ky)) + exp(-2 * 1j * a * kx))],
                       [-2j * t3 * sin(c * kz), -2j * t3 * sin(c * kz), -2j * t3 * sin(c * kz) * exp(2 * 1j * a * kz),
                        t1 * (1 + exp(-2 * 1j * (-a / 2 * kx + sqrt(3) / 2 * a * ky)) + exp(2 * 1j * a * kx)),
                        p + 2 * t11 * cos(c * kz)]])
        return Hd
    ...
    def Hp(kx, ky, kz):
        Hp = np.array([[0, 0, 0, 2j * tso * sin(a / 2 * kx + sqrt(3) / 2 * a * ky), exp(1j * 5 * pi / 6)],
                       [0, 0, 0, exp(1j * pi / 2) * exp(-2 * 1j * (-a / 2 * kx + sqrt(3) / 2 * a * ky)),
                        exp(-1j * pi / 2)],
                       [0, 0, 0, exp(-1j * 5 * pi / 6), exp(1j * pi / 6) * exp(-2 * 1j * a * kx)],
                       [exp(1j * 5 * pi / 6), exp(-1j * pi / 2) * exp(2 * 1j * (-a / 2 * kx + sqrt(3) / 2 * a * ky)),
                        exp(1j * pi / 6), 0, 0],
