...
def Berryphase(ener):
    ...
    for i in range(len(kx)-1):
         for j in range(len(ky)-1):
            ...
            chern_2 = chern_2 + ((partial10x - partial10y) / ((eng1 - eng0) ** 2) + (partial12x - partial12y)/((eng1 - eng2) ** 2))*Delta**2*stepfunction(eng1,ener)*0
            ...
            chern_3 = chern_3 + ((partial20x - partial20y) / ((eng2 - eng0) ** 2) + (partial21x - partial21y)/((eng2 - eng1) ** 2))*Delta**2*stepfunction(eng2,ener)*0
